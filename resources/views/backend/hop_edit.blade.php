    ...
    <div class="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <div class="rounded-lg bg-white px-5 py-6 shadow sm:px-6">
            ...
            <div class="h-auto rounded-lg border-4 border-dashed border-gray-200 p-8">
                ...
                <form method="POST" action="{{ route('hop.update', $hop->id) }}" class="space-y-8 divide-y divide-gray-200">
                  @csrf  {{ csrf_field() }}
                    <div class="space-y-8 divide-y divide-gray-200">
                      <div>
                        ...
                        <div class="sm:col-span-12">
                            ...
                            <div class="mt-1">
                                <input value="{{$hop->name}}" type="text" name="name" id="name" autocomplete="given-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
                        <div class="sm:col-span-12">
                            <label for="about" class="block text-sm font-medium text-gray-700">Pequeña Descripción de el lúpulo</label>
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                  {{$hop->description}}
                                </textarea>
                            </div>                            
                        </div>                        
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" value="{{$hop->type}}" name="type" id="type" autocomplete="family-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
                        <div class="sm:col-span-6">
                            <label for="last-name" class="block text-sm font-medium text-gray-700">Alfa</label>
                            <div class="mt-1">
                                <input type="text" value="{{$hop->decimal}}" name="decimal" id="decimal" autocomplete="family-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>                                                                                               
                          <div class="sm:col-span-12">
