          ...
          <div class="h-auto rounded-lg border-4 border-dashed border-gray-200 p-8">
              ...
              <form class="space-y-8 divide-y divide-gray-200">
                  <div class="space-y-8 divide-y divide-gray-200">
                    <div>
                      <div>
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Ingrediente Fermentable</h3>
                        <p class="mt-1 text-sm text-gray-500">Aqui podrás dar añadir el ingrediente fermentable de tu receta que no esta dada de alta en nuestro sistema, muchas gracias de antemano por colaborar</p>
                      </div>
                
                      <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-12">     
                      <div class="sm:col-span-12">
                          <label for="first-name" class="block text-sm font-medium text-gray-700">Titulo del ingrediente Fermentable</label>
                          <div class="mt-1">
                      ...
                      <div class="sm:col-span-12">
                          <label for="about" class="block text-sm font-medium text-gray-700">Pequeña Descripción del ingrediente Fermentable</label>
                          <div class="mt-1">
                      ...
                      <div class="sm:col-span-4">
                          <label for="last-name" class="block text-sm font-medium text-gray-700">Extracto</label>
                          <div class="mt-1">
                              <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                          </div>
                      </div>
                      <div class="sm:col-span-4">
                          <label for="last-name" class="block text-sm font-medium text-gray-700">Porcentaje</label>
                          <div class="mt-1">
                              <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                          </div>
                      </div>   
                      <div class="sm:col-span-4">
                        <label for="last-name" class="block text-sm font-medium text-gray-700">Fermentable</label>
                        <div class="mt-1">
                            <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>  
                      <div class="sm:col-span-4">
                        ...
                        <div class="sm:col-span-12">
                          <label for="cover-photo" class="block text-sm font-medium text-gray-700">Subir Fotos del ingrediente Fermentable</label>
